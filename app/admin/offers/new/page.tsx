        ...
        <div className="max-w-4xl pb-20">
            ...
            <div className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {OFFER_TYPES.map(({ value, label, desc }) => (
                            <button
                                ...
                                className={`px-5 py-4 border text-left transition-all ${offerType === value
                                    ? 'border-gold bg-gold/5'
                                    : 'border-white/10 text-white/40 hover:border-white/30'
                                    }`}
                            >
                                <span className={`block font-sans text-[10px] uppercase tracking-[0.2em] font-medium mb-1 ${offerType === value ? 'text-gold' : 'text-white/60'}`}>{label}</span>
                                <span className="block font-sans text-[9px] text-white/30 tracking-wide">{desc}</span>
                            </button>
                        ))}
                    </div>
                </div>
                ...
                <div className="bg-rich-black/30 p-8 border border-white/5 space-y-8">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. Buy Any Shirt, Get Trousers Free"
                        />
                    </div>
                    <div>
                        ...
                        <div className="space-y-8">
                            <div className="border border-gold/20 bg-gold/5 px-5 py-4">
                                <p className="font-sans text-[10px] text-gold/80 leading-relaxed">
                                    <span className="font-semibold text-gold uppercase tracking-wider block mb-1">How BOGO Works</span>
                                    Customer purchases the "Buy" product(s) and receives the "Get (Free)" product(s) at no extra charge.
                                </p>
                            </div>
                ...
                <div className="flex gap-4 pt-8">
                    <button onClick={handleCreate} disabled={createOffer.isPending} className="px-12 py-4 bg-white text-black font-sans text-[10px] font-medium uppercase tracking-[0.3em] hover:bg-gold hover:text-white transition-colors duration-500 disabled:opacity-50 flex items-center gap-3">
