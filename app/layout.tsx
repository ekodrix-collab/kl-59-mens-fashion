...
export const metadata: Metadata = {
  ...
  metadataBase: new URL((process.env.NEXT_PUBLIC_SITE_URL && !process.env.NEXT_PUBLIC_SITE_URL.includes('localhost')) ? process.env.NEXT_PUBLIC_SITE_URL : 'https://kl-59-mens-fashion.vercel.app'),
  openGraph: {
    ...
    url: (process.env.NEXT_PUBLIC_SITE_URL && !process.env.NEXT_PUBLIC_SITE_URL.includes('localhost')) ? process.env.NEXT_PUBLIC_SITE_URL : 'https://kl-59-mens-fashion.vercel.app',
